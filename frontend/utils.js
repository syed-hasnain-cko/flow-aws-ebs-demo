...
async function fetchPaymentDetails(id){
    queryParams = new URLSearchParams({
        ...
        const paymentResponse = await fetch(`https://axzepxqz10.execute-api.us-east-1.amazonaws.com/dev/get-payment-details?${queryParams.toString()}`, {
            method: 'GET',
            headers: {
...
async function voidPayment(id){
    ...
    try{
        const voidResponse = await fetch(`https://axzepxqz10.execute-api.us-east-1.amazonaws.com/dev/void-payment?${queryParams.toString()}`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        }
...
async function capturePayment(id){
    ...
    try{
        const captureResponse = await fetch(`https://axzepxqz10.execute-api.us-east-1.amazonaws.com/dev/capture-payment?${queryParams.toString()}`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        }
...
async function refundPayment(id){
    ...
    try{
        const refundResponse = await fetch(`https://axzepxqz10.execute-api.us-east-1.amazonaws.com/dev/refund-payment?${queryParams.toString()}`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        }
...
async function updatePaymentDetailsData(id){
    ...
    const actionsResponse = await fetch(`https://axzepxqz10.execute-api.us-east-1.amazonaws.com/dev/get-payment-actions?paymentId=${paymentData.id}`, {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json',
        }
...
function modifyCardNetworks(cardNetworks) {
  ...
  function getConfig(callback) {
    fetch("https://axzepxqz10.execute-api.us-east-1.amazonaws.com/dev/config", {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      },
